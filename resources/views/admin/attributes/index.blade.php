...
@section('content')
    ...
    <div class="row">
            ...
            <form action="{{ route('admin.attributes.store') }}" method="POST">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Add new attribute</h4>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                        ...
                        <div class="text-start mb-3">
                            <button type="submit" class="btn btn-success w-sm">Add new attribute</button>
                        </div>
                    </div>
                </div>
            </form>
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">All attribute</h4>
                </div><!-- end card header -->
                                ...
                                <tbody class="list form-check-all">
                                    @foreach($attributes as $item)
                                        <tr>
                                            ...
                                            <td>
                                                @if($item->attributeValues->count())
                                                    @foreach($item->attributeValues as $valueItem)
                                                        {{ $valueItem->attribute_value_name }},
                                                    @endforeach
                                                @endif
                                            </td>
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <div class="edit">
                                                        <button class="btn btn-sm btn-info show-item-btn" data-bs-toggle="modal"
