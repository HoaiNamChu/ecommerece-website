                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <select name="parent_id" id="parent-id" class="form-select">
                                ...
                                @foreach($categories as $item)
                                    @php
                                        $dash = ' ';
                                    @endphp
                                    @include('components.admin.categories.form-add-select', ['item'=>$item, 'dash'=>$dash])
                                @endforeach
                            </select>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="text-start mb-3">
                            <button type="submit" class="btn btn-success w-sm">Add new category</button>
                        </div>
                    </div>
                </div>
            </form>
                            ...
                            <table class="table align-middle table-nowrap" id="customerTable">
                                ...
                                @foreach($categories as $category)
                                    @php
                                        $dash = ' ';
                                    @endphp
                                    @include('components.admin.categories.list-table',['category'=>$category, 'dash' => $dash])
                                @endforeach
                                </tbody>
                            </table>
