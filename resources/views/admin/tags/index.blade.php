            ...
            <form action="{{ route('admin.tags.store') }}" method="POST">
                ...
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Add new tag</h4>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" type="text" rows="5" id="tag-description" name="tag_description"></textarea>
                        </div>
                        <div class="text-start mb-3">
                            <button type="submit" class="btn btn-success w-sm">Add new tag</button>
                        </div>
                    </div>
                </div>
            </form>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                ...
                                                <div class="remove">
                                                    <form action="{{ route('admin.tags.destroy', $item) }}"
                                                          method="post">
                                                        @csrf
                                                        @method('DELETE')
